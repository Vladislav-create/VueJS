    ...
    <div class="box-content">
        ...
        <section class="main-content center">
            <section class="main-content__header">
                <h3 class="main-content__header__title">Follow Our Projects</h3>
                <p class="main-content__header__subtitle">It is a long established fact that a reader will be distracted by the of readable content of page  lookings at its layouts  points.</p>
            </section>
            <div class="box-carts">
                <article class="cart">
                    ...
                    <section class="cart__infobox">
                        <div class="cart__info">
                            ...
                            <a href="#" class="cart__bread-crumbs">Decor</a>
                            <span class="cart__bread-crumbs-seporate">/</span>
                            <a href="#" class="cart__bread-crumbs">Artchitecture</a>
                        </div>
                        <div class="cart__btn">
